...
- Scroll screens: frame stays 390×844 (clip on, vertical overflow); Status Bar + bottom bar/CTA + Home Indicator are fixed (topmost layers); Content paddingBottom = bar height + 24. Screen3_Review `1104:123`.
